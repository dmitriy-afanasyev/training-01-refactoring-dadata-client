...
### 2.1. Factories - Фабрики

В данном проекте Фабрики отсутствуют в силу простого создания сущностей. Однако стоит упомянуть о фабриках так как это важный элемент DDD - [Фабрики](./Factories/README.md)
