 ...
 * (Что для большинства легаси-говно-проектов на самом деле не плохая альтернатива!)
 * 
 * Следует понимать что реализовать сразу на 100% DDD не возможно - это поэтапный, итерационный процесс.
 ...
 * или зависимость от фреймворка (причем более лайтовая зависимость нежели это было во времена 2000х)?
 * 
